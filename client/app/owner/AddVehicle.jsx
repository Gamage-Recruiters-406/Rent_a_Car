...
// Dropdown options
const VEHICLE_TYPES = ["Car", "Van", "SUV", "Pickup", "Bus", "Bike", "ThreeWheel", "Other"];
...
// ────────────────────────────────────────────
const DropdownPicker = ({ label, required, options, value, onSelect, placeholder }) => {
    const [open, setOpen] = useState(false);
    return (
        <View className="mb-4">
            <Text className="text-sm font-semibold mb-1.5" style={{ color: "#0D3778" }}>
                    ...
                    <View className="bg-white rounded-t-2xl max-h-[60%]">
                        ...
                        <ScrollView className="px-2 py-2">
                            {options.map((opt) => (
                                ...
                                >
                                    <Text
                                        className={`text-base ${value === opt ? "font-semibold text-blue-700" : "text-gray-700"
                                            }`}
                                    >
                                        {opt}
                                    </Text>
        ...
        <SafeAreaView className="flex-1 bg-gray-100" edges={["bottom"]}>
            ...
            >
                ...
                >
                    ...
                    >
                        {/* Header */}
                        <View className="mb-5">
                            <Text className="text-2xl font-bold mb-1" style={{ color: "#0D3778" }}>
                                Add New Vehicle
                            </Text>
                        ...
                        <View className="mb-4">
                            ...
                            <TextInput
                                className="border-2 rounded-lg px-3 py-2.5 text-gray-800 bg-white"
                                style={{ borderColor: "#0D3778", minHeight: 90, textAlignVertical: "top" }}
                        ...
                        {/* ─── Rental Amount ─── */}
                        <View className="mb-4">
                            <Text className="text-sm font-semibold mb-2" style={{ color: "#0D3778" }}>
                                Rental Amount <Text className="text-red-500">*</Text>
                            </Text>
                            <View className="flex-row gap-3">
                                <View className="flex-1">
                                    <Text className="text-xs text-gray-500 mb-1">Daily Rental Rate</Text>
                                ...
                                <View className="flex-1">
                                    <Text className="text-xs text-gray-500 mb-1">Per Kilometer Charge</Text>
                                    <View className="flex-row items-center">
                                        <TextInput
                                            className="flex-1 border-2 rounded-lg px-3 py-2.5 text-gray-800 bg-white"
                                            style={{ borderColor: "#0D3778" }}
                            ...
                            {photos.length > 0 && (
                                <View className="mt-3">
                                    <View className="flex-row items-center mb-2">
                                        ...
                                        <Text className="text-sm font-semibold ml-1.5" style={{ color: "#0D3778" }}>
                        ...
                        <View className="flex-row gap-3 mt-2">
                            ...
                            >
                                ...
                                <Text className="font-semibold ml-2" style={{ color: "#0D3778" }}>
                                    Save Draft
                                </Text>
                            </TouchableOpacity>
            ...
            <Modal visible={showMap} animationType="slide" presentationStyle="fullScreen">
                <SafeAreaView className="flex-1 bg-white">
                    ...
                    {/* Map */}
                    <View className="flex-1 mx-4 mb-3 rounded-xl overflow-hidden border-2" style={{ borderColor: "#0D3778" }}>
                        <MapView
                            ref={mapRef}
                            style={{ flex: 1 }}
                            initialRegion={{
                    ...
                    <View className="mx-4 mb-2 px-3 py-2.5 bg-blue-50 rounded-lg flex-row items-start">
                        ...
                        <Text className="text-xs text-gray-600 ml-2 flex-1">
                            Tap on the map to place a marker, drag the marker to adjust, or use the button above to set your current location.
                        </Text>
                    </View>
