...
export default function VehicleBookingPage() {
    ...
    return (
        <AppLayout headerProps={{ title: 'Vehicle Booking' }}>
                    ...
                    >
                        ...
                        <View className="px-4 py-8 items-center">
                            ...
                            <View className="w-full max-w-sm bg-[#1e3a5f]/90 p-6 rounded-xl border border-white/10 mb-8">
                                ...
                                <View className="mb-6">
                                    <View className="bg-gray-200 rounded px-3 py-2 flex-row items-center mb-1">
                                        <Upload size={12} color="#4b5563" />
                                        <Text className="text-gray-600 text-xs font-medium ml-1">ID/NIC Upload</Text>
                                    </View>
                                    <TouchableOpacity
                                        onPress={pickIdImage}
                                        className="w-full bg-white rounded px-3 py-3 items-center border border-dashed border-gray-300"
                                    >
                                        {idImage ? (
                                            <Text className="text-gray-900 text-xs" numberOfLines={1}>{idImage.fileName || 'Image Selected'}</Text>
                                        ) : (
                                            <Text className="text-gray-500 text-xs">Tap to upload ID/NIC image</Text>
                                        )}
                                    </TouchableOpacity>
                                </View>
