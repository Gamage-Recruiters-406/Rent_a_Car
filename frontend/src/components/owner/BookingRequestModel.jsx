...
const BookingModal = ({ isOpen, onClose, data, refreshData, allBookings = [] }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 font-sans leading-relaxed">
      <div className="relative w-full max-w-[420px] bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border-t-[6px] border-[#0D3778] animate-in fade-in zoom-in duration-200">
