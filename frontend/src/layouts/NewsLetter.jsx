    ...
    <div>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="w-full px-4 sm:px-6 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto px-4">
            <input
              type="email"
            ...
            <button
              type="submit"
              className="px-8 sm:px-10 py-4 bg-[#0d3778] text-white rounded-xl font-semibold hover:bg-[#082555] hover:shadow-lg hover:-translate-y-0.5 transition-all"
            >
              Subscribe
            </button>
          </form>
